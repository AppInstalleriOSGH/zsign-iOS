CC := clang
CFLAGS := -Wall -Werror $(shell pkg-config --cflags libcrypto) -fPIC -Wno-pointer-to-int-cast -Wno-unused-command-line-argument -Wno-deprecated-declarations -Wno-unused-but-set-variable -framework CoreFoundation
DEBUG ?= 0
ifeq ($(DEBUG), 1)
